...
export function Hero() {
    return (
        <Container className="pb-16 pt-20 text-center lg:pt-32">
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-indigo-100 sm:text-7xl">
                We design physical
          ...
          <span className="relative">experiences</span>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-indigo-200">
                We're a full-service interior design agency who specialize in simple, useful and beautiful solutions for
                any space.
            </p>
            <div className="mt-10 flex justify-center gap-x-6">
                <Button
                    ...
                    <svg
                        aria-hidden="true"
                        className="h-3 w-3 flex-none fill-indigo-400 group-active:fill-current">
                        <path
